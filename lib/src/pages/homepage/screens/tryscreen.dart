...
class BololoScreen extends StatefulWidget {
  const BololoScreen({Key? key}) : super(key: key);

  @override
  State<BololoScreen> createState() => _BololoScreenState();
}

class _BololoScreenState extends State<BololoScreen> {
