      ...
      return Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              const Text('Get help from our support team 😊',style: TextStyle(fontWeight: FontWeight.w700,fontFamily: 'PTSans_Regular',fontSize: 23,color: Color(0xff363131)),),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                            primary: const Color(0xffE0E8F3),
                            elevation: 1,
                      ...
                      contentPadding: const EdgeInsets.only(left: 1,top: 5),
                      leading: const FaIcon(FontAwesomeIcons.message,size: 26, color: Color(0xff0B449C), ),
                      title: Padding(
                ...
                children: [
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      contentPadding: const EdgeInsets.only(left: 1,top: 5),
                      leading: const FaIcon(FontAwesomeIcons.twitter,size: 26, color: Color(0xff0B449C), ),
                      title: Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: Column(
                ...
                children: [
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      contentPadding: const EdgeInsets.only(left: 1,top: 5),
                      leading: const FaIcon(FontAwesomeIcons.facebook,size: 26, color:  Color(0xff0B449C), ),
                      title: Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: Column(
                ...
                children: [
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      contentPadding:const EdgeInsets.only(left: 1,top: 5),
                      leading: const FaIcon(FontAwesomeIcons.instagram,size: 26, color: Color(0xff0B449C), ),
                      title: Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: Column(
                ...
                children: [
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      contentPadding: const EdgeInsets.only(left: 1,top: 5),
                      leading: const FaIcon(FontAwesomeIcons.whatsapp,size: 26, color: Color(0xff0B449C), ),
                      title: Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: Column(
                ...
                children: [
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      contentPadding: const EdgeInsets.only(left: 1,top: 5),
                      leading: const FaIcon(FontAwesomeIcons.phone,size: 25, color: Color(0xff0B449C), ),
                      title: Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: Column(
      ...
      children: [
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            contentPadding:const  EdgeInsets.only(left: 1,top: 5),
            leading: const FaIcon(FontAwesomeIcons.twitter,size: 30, color: Color(0xff0B449C), ),
            title: Padding(
              padding: const EdgeInsets.only(top: 10),
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('$title',style: const TextStyle(fontWeight: FontWeight.w700,fontFamily: 'PTSans_Regular',fontSize: 14,color: Color(0xff0B449C)),),
                  const SizedBox(height: 2.5,),
                  Text('Want to reach us by $subTitle tap here',style: const TextStyle(fontWeight: FontWeight.w400,fontFamily: 'PTSans_Regular',fontSize: 13,color: Color(0xff000000)),),
                ],
              ),
            ),
          )),
